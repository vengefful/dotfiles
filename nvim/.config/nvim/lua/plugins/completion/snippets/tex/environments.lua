...
return {
	...
	-- My Custom Question on List of Exercises
	s(
		{ trig = "nq", snippetType = "autosnippet" },
		fmta(
			[[
	...
	-- Tasks
	s(
		{ trig = "tsk", snippetType = "autosnippet" },
		fmta(
			[[
        \begin{tasks}
          \task <>
	...
	-- GENERIC ENVIRONMENT
	s(
		{ trig = "nbm", snippetType = "autosnippet" },
		fmta(
			[[
        \begin{bmatrix}
          <>
